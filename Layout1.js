  ...
  export default function Layout1({route,navigation}) {
    ...
    return (
      ...
      <Image style={styles.image} source={{uri:'https://aqueous-tor-75407.herokuapp.com/gambar/'+dataList.foto}}/>
    ...
    <Text
      ...
      <View
        ...
        >
          Kategori Buku : {dataList.kategori_buku}
        </Text>
        <Text
          style={{
        ...
        >
        Tahun Terbit : {dataList.tahun_terbit}
        </Text>
        <Text
          style={{
